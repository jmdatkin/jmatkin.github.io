         ...
         <div className={`w-full h-full bg-white`}>
          <div className="flex flex-col h-full">
            <div className="flex min-h-[5rem] border-b">
              <div className="w-screen-layout-offset border-r hidden sm:block bg-zinc-100"></div>
              <div className="flex-grow items-center">
                <Navbar></Navbar>
              </div>
              <div className="w-screen-layout-offset border-l hidden sm:block bg-zinc-100"></div>
            </div>
